...
const styles = {
  "node_modules/nuxt/dist/app/entry.js": () => import('./_nuxt/entry-styles.71bc94a5.mjs').then(interopDefault),
  ...
  "layouts/auth.vue": () => import('./_nuxt/auth-styles.996415db.mjs').then(interopDefault)
};
