...
const inlineAppConfig = {
  "nuxt": {
    "buildId": "aa7c2b7d-2278-4fa3-ac17-3369f121a2dd"
  }
};
...
const _inlineRuntimeConfig = {
  ...
  "public": {
    "CONFIG_CAT_SDK_KEY": "EHnbCD4GRUSLie4o-KE_jA/vPsC7jK0-0Ob8iweZ6-6ag",
    "persistedState": {
      "storage": "cookies",
      "debug": false,
      "cookieOptions": {}
...
storage.mount('data', unstorage_47drivers_47fs_45lite({"driver":"fsLite","base":"/home/pato/apps/nuxt-starter/.data/kv"}));
...
const _Z9hbwIuBWC = (function(nitro) {
...
class HTTPException {
  constructor(exception) {
    ...
    __publicField(this, "status_code");
...
const handleError = (event, err) => {
  ...
  return {
    message: "We're sorry, an unexpected internal error has occurred. Our team has been notified and is actively investigating.",
    status_code: 500,
...
const _K3ti1X = defineEventHandler(async (event) => {
  var _a;
  try {
    const path = event.path;
    if (path.includes("/api/")) {
      const pathIsExcluded = excludePaths.filter((v) => path.includes(v)).length >= 1;
      const pathIsForceIncluded = forceIncludePaths.filter((v) => path.includes(v)).length >= 1;
      if (!pathIsExcluded || pathIsForceIncluded) {
        const bearerTokenHeader = getHeader(event, "Authorization") || getHeader(event, "authorization") || ((_a = getQuery(event)) == null ? void 0 : _a.bearer_token);
        ...
        if ((user == null ? void 0 : user.status) !== "approved") {
          throw new HTTPException({
...
const isActive = async (flag) => await configCatClient.getValueAsync(flag, false);
...
const flags = [
  {
    ...
    message: "The authentication and user management insn't available right now! We are working on it."
  },
  {
    feature: "feature",
...
const _c7rigt = defineEventHandler(async (event) => {
  try {
    const path = event.path;
    ...
    if (path.includes("/api/") && feature) {
      const isFeatureActive = await (feature == null ? void 0 : feature.active());
      if (!isFeatureActive) {
        throw new HTTPException({
          message: (feature == null ? void 0 : feature.message) || `The "${feature == null ? void 0 : feature.feature}" feature is not available now! We are working on it.`,
...
const _31t3yc = defineEventHandler(async (event) => {
  const routeRules = getRouteRules(event);
...
const _CMx1sG = defineEventHandler(async (event) => {
...
const _omrzkX = defineEventHandler(async (event) => {
  const routeRules = getRouteRules(event);
...
const _ig7JNR = defineEventHandler((event) => {
  const routeRules = getRouteRules(event);
  handleCors(event, routeRules.security.corsHandler);
});

const _lazy_avWRU3 = () => import('../index.delete.mjs');
const _lazy_KOH7J7 = () => import('../index.get.mjs');
const _lazy_asmnXA = () => import('../index.put.mjs');
const _lazy_0dDnA6 = () => import('../index.get2.mjs');
const _lazy_PPt2up = () => import('../change-password.patch.mjs');
const _lazy_9TWC8D = () => import('../forgot-password.post.mjs');
const _lazy_eg9XjM = () => import('../refresh-token.post.mjs');
const _lazy_jUNDDp = () => import('../reset-password.patch.mjs');
const _lazy_yUD1LM = () => import('../revert-password-change.patch.mjs');
const _lazy_Cx0G66 = () => import('../sign-in.post.mjs');
const _lazy_CKbXjQ = () => import('../sign-out.post.mjs');
const _lazy_wGnUbW = () => import('../sign-up.post.mjs');
const _lazy_LQ0guJ = () => import('../index.get3.mjs');
const _lazy_xwJsTH = () => import('../index.delete2.mjs');
const _lazy_pW8ti7 = () => import('../index.get4.mjs');
const _lazy_uqtinx = () => import('../index.delete3.mjs');
const _lazy_61VCG6 = () => import('../index.get5.mjs');
const _lazy_JcdZoW = () => import('../index.put2.mjs');
const _lazy_SoTvh4 = () => import('../handlers/renderer.mjs').then(function (n) { return n.r; });

const handlers = [
  { route: '', handler: _K3ti1X, lazy: false, middleware: true, method: undefined },
  { route: '', handler: _c7rigt, lazy: false, middleware: true, method: undefined },
  { route: '/api/v1/admin/users/:id', handler: _lazy_avWRU3, lazy: true, middleware: false, method: "delete" },
  { route: '/api/v1/admin/users/:id', handler: _lazy_KOH7J7, lazy: true, middleware: false, method: "get" },
  { route: '/api/v1/admin/users/:id', handler: _lazy_asmnXA, lazy: true, middleware: false, method: "put" },
  { route: '/api/v1/admin/users', handler: _lazy_0dDnA6, lazy: true, middleware: false, method: "get" },
  { route: '/api/v1/auth/change-password', handler: _lazy_PPt2up, lazy: true, middleware: false, method: "patch" },
  { route: '/api/v1/auth/forgot-password', handler: _lazy_9TWC8D, lazy: true, middleware: false, method: "post" },
  { route: '/api/v1/auth/refresh-token', handler: _lazy_eg9XjM, lazy: true, middleware: false, method: "post" },
  { route: '/api/v1/auth/reset-password', handler: _lazy_jUNDDp, lazy: true, middleware: false, method: "patch" },
  { route: '/api/v1/auth/revert-password-change', handler: _lazy_yUD1LM, lazy: true, middleware: false, method: "patch" },
  { route: '/api/v1/auth/sign-in', handler: _lazy_Cx0G66, lazy: true, middleware: false, method: "post" },
  { route: '/api/v1/auth/sign-out', handler: _lazy_CKbXjQ, lazy: true, middleware: false, method: "post" },
  { route: '/api/v1/auth/sign-up', handler: _lazy_wGnUbW, lazy: true, middleware: false, method: "post" },
  { route: '/api/v1/feature', handler: _lazy_LQ0guJ, lazy: true, middleware: false, method: "get" },
  { route: '/api/v1/sessions', handler: _lazy_xwJsTH, lazy: true, middleware: false, method: "delete" },
  { route: '/api/v1/sessions', handler: _lazy_pW8ti7, lazy: true, middleware: false, method: "get" },
  { route: '/api/v1/user/me', handler: _lazy_uqtinx, lazy: true, middleware: false, method: "delete" },
  { route: '/api/v1/user/me', handler: _lazy_61VCG6, lazy: true, middleware: false, method: "get" },
  { route: '/api/v1/user/me', handler: _lazy_JcdZoW, lazy: true, middleware: false, method: "put" },
  { route: '/__nuxt_error', handler: _lazy_SoTvh4, lazy: true, middleware: false, method: undefined },
  { route: '', handler: _31t3yc, lazy: false, middleware: false, method: undefined },
  { route: '', handler: _CMx1sG, lazy: false, middleware: false, method: undefined },
  { route: '', handler: _omrzkX, lazy: false, middleware: false, method: undefined },
  { route: '', handler: _ig7JNR, lazy: false, middleware: false, method: undefined },
  { route: '/**', handler: _lazy_SoTvh4, lazy: true, middleware: false, method: undefined }
];
...
export { $fetch as $, sanitizeStatusCode as A, createHooks as B, defu as C, parse as D, ErrorCodes as E, destr as F, isEqual as G, HTTPException as H, setCookie as I, getCookie as J, deleteCookie as K, parseQuery as L, withTrailingSlash as M, withoutTrailingSlash as N, klona as O, handler as P, defineEventHandler as a, getRequestHost as b, getRequestHeader as c, dr as d, eventHandler as e, setResponseHeader as f, getRequestProtocol as g, handleError as h, send as i, getResponseStatus as j, setResponseHeaders as k, joinURL as l, useRuntimeConfig as m, getQuery as n, createError$1 as o, prismaClient as p, getRouteRules as q, readBody as r, setResponseStatus as s, getResponseStatusText as t, useNitroApp as u, withQuery as v, wn as w, hasProtocol as x, parseURL as y, isScriptProtocol as z };
